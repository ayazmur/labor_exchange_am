...
class ResponseRepository(IRepositoryAsync):
    ...
    async def retrieve(self, include_relations: bool = False, **kwargs) -> ResponseModel:
        ...
        response_model = self._to_response_model(
    ...
    async def update(self, id: int, response_update_dto: ResponseUpdateSchema) -> ResponseModel:
        ...
        new_response = self._to_response_model(response_from_db)
        return new_response
    ...
    async def delete(self, id: int):
        ...
        return self._to_response_model(response_from_db)

    @staticmethod
    def _to_response_model(response_from_db: Response) -> ResponseModel:
        response_model = None
